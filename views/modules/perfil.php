    ...
    <div class="row d-flex justify-content-center text-center">
      ...
      <div class="col-md-6 shadow  bg-white rounded ">
        ...
        <div class="shadow  bg-white rounded">
          ...
          <p class="" style=" padding-left: 70px; padding-right: 70px;"> <small>Se recomienda usar una contraseña segura y no compartirla con nadie.</small></p>
          <button class="btn btn-info" type="button" name="button">Configurar</button>
          <br>
          <br>
        </div>
        <br>
        <div class="shadow  bg-white rounded">
          <br>
          <h4 class="text-info">Configuracion de pin</h4>
          <p class="" style=" padding-left: 70px; padding-right: 70px;"><small>Se recomienda usar un segur y no compartirla con nadie.</small></p>
          <button class="btn btn-info" type="button" name="button">Configurar</button>
          <br>
          <br>
        </div>
